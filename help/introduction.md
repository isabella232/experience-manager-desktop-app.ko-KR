...
description: Adobe Experience Manager 데스크탑 앱을 사용하여 데스크탑에서 직접 Adobe Experience Manager 에셋을 사용할 때 크리에이티브 사용자를 위한 에셋 관리 워크플로우를 최적화하는 방법을 살펴볼 수 있습니다.
contentOwner: AG
...
>[!NOTE]
>
>Adobe Experience Manager 데스크탑 앱은 Adobe Experience Manager 6.1 릴리스에서 도입되었으며 이전에 Adobe Experience Manager 에셋 부록 앱이라고 불렸다. 앱 버전 1.x의 도움말은 왼쪽 사이드바의 TOC를 참조하십시오. 최신 버전 2로 업그레이드하는 것이 좋습니다.
